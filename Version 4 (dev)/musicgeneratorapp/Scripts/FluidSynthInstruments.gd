...
var FLUIDSYNTH_INSTRUMENTS = ['Violins', 'Electric Piano', 'Organ', 'Plucked Guitar', 'Choir','Trumpet', '40s brass', 'Synth & Keys', 'Harpsichord', 'Fantasy Piano', 'Alto Sax', 'Strings', 'Voices', 'Alaska Synth']
