...
class FantasyGenre(GenreBase):
    ...
    def _build_rhythm(self) -> RhythmInfo:
        ...
        probabilities = {
            "full": {(1, 3): 0.5, (2, 4): 0.5, (1, 2, 3): 0.8},
            "half": {(1, 3): 0.7, (2, 4): 0.8, (1, 2, 3): 0.7, (1, 2, 3, 4): 0.6},
        }
    ...
    def _build_melody(self) -> MelodyInfo:
        ...
        note_weights = {0: 0.1, 1: 0.7, 2: 0.2}
        rest_weights = [0, 0, 0]
    ...
    def _build_structure(self) -> StructureInfo:
        ...
        chords_instruments = ["piano", "cellos", "strings", "woodwinds", "brass"]
