...
class SongGeneration:
    ...
    def __init__(self, key, style='major', length=4, verses=1, verse_type="verse", rhythm=[], startRoot=True, file_name="test", file_location=""):
        self.key = key
...
def fullSongGen(key, minorKey, folder, song_style, script_dir, startRoot=True):
    ...
    verse1 = SongGeneration(key, style=song_style, length=4, verses=1,
                            verse_type="verse", startRoot=startRoot, file_name="verse1", file_location=folder)
    verse1.gen_song()
    f.write("Verse 1\n")
    f.write(str(verse1))
    ...
    chorus = SongGeneration(key, style=song_style, length=4, verses=1,
                            verse_type="chorus", startRoot=startRoot, file_name="chorus", file_location=folder)
    chorus.gen_song()
    f.write("\nChorus\n")
    f.write(str(chorus))
    ...
    verse2 = SongGeneration(key, style=song_style, length=4, verses=1,
                            verse_type="verse", startRoot=startRoot, file_name="verse2", file_location=folder)
    verse2.gen_song()
    f.write("\nVerse 2\n")
    f.write(str(verse2))
    ...
    bridge = SongGeneration(key, style=song_style, length=7, verses=1,
                            verse_type="bridge", startRoot=startRoot, file_name="bridge", file_location=folder)
    bridge.gen_song()
    f.write("\nBridge\n")
    f.write(str(bridge))
    ...
    if song_style == "major":
        minorBridge = SongGeneration(minorKey, style="minor", length=7, verses=1,
                                     verse_type="bridge", startRoot=startRoot, file_name="minorBridge", file_location=folder)
