...
class AnimeGenre(GenreBase):
    ...
    def _build_rhythm(self) -> RhythmInfo:
        ...
        probabilities = {
            "full": {(1, 3): 0, (2, 4): 0, (1, 2, 3): 0.1},
            "half": {(1, 3): 0, (2, 4): 0.4, (1, 2, 3): 0.8, (1, 2, 3, 4): 0.7},
        }
    ...
    def _build_melody(self) -> MelodyInfo:
        ...
        note_weights = {0: 0.1, 1: 0.8, 2: 0.1}
        rest_weights = [0, 0, 0]
    ...
    def _build_structure(self) -> StructureInfo:
        melody_instruments = ["piano", "violin", "bells", "flute"]
        chords_instruments = ["strings", "woodwinds", "piano (quiet)"]
