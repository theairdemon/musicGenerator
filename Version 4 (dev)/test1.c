...
/*
Build command: gcc -I./fluidsynth/include test1.c -L./fluidsynth/build/src
-lfluidsynth -lm -lpthread -ldl -o test1 Run command: ./test1
../soundfonts/1_FantasyPiano.sf2 ../midi_files/album_2/cyberpunk_2/fullSong.mid
*/
  ...
  */
  ...
  int synth_array[14] = {
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
                         "ViolinsLong.sf2",
                         1),
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
                         "198_Yamaha_SY1_piano.sf2",
                         1),
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
      ...
      fluid_synth_sfload(
          synth,
          "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/Hpschd.SF2", 1),
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
                         "1_FantasyPiano.sf2",
                         1),
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
                         "198_u20_alto_sax.SF2",
                         1),
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
                         "336_Massive_strings.sf2",
                         1),
      fluid_synth_sfload(synth,
                         "/mnt/DATA/Documents/Github/musicGenerator/soundfonts/"
                         "LustyVoices.sf2",
  ...
  for (int i = 0; i < 3; i++) {
    for (int j = 0; j < 3; j++) {
      ...
      fluid_synth_program_select(synth, i + (j * 3),
                                 synth_array[instruments[i]], 0, 0);
    }
  }
